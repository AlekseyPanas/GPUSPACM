...
if __name__ == "__main__":
    ...
    # sim = SPACM1DSim(0.03, -1, 0.01, [3, 5, 7], [0, 1, 2], [0, 8], [1, 1, 1], 1, 1, 0.01, NumpyLogger(LOG_ROOT_PATH, do_log, "SingleBallHardcodedLayersDissipationTest"))  # Working three-particle two-wall sim, but bounces are too far
